...
func (pthis*MsgQueSrv)TcpDialConnection(fd lin_common.FD_DEF, addr net.Addr, inAttachData interface{})(outAttachData interface{}) {
	...
	pthis.SendProtoMsg(fd, uint16(msgpacket.PB_MSG_INTER_TYPE__PB_MSG_INTER_QUESRV_REGISTER), pbMsgReg)
...
func (pthis*MsgQueSrv)TcpData(fd lin_common.FD_DEF, readBuf *bytes.Buffer, inAttachData interface{})(bytesProcess int, outAttachData interface{}) {
	...
	lin_common.LogInfo("packType", packType)
	return 0,nil
}
...
func (pthis*MsgQueSrv)SendProtoMsg(fd lin_common.FD_DEF, msgType uint16, protoMsg proto.Message){
...
func ConstructMsgQueSrv(msgqueCenterAddr string, addr string, epollCoroutineCount int) *MsgQueSrv{
	mqMgr := &MsgQueSrv{}
