...
void test_string_set_maxpre_search()
{
	char * key1 = "123";
	char * key2 = "12";
	char * key3 = "88";
	...
	StringSetAdd(hss, key1, key1 + strlen(key1), key1, strlen(key1));
	StringSetAdd(hss, key2, key2 + strlen(key2), key2, strlen(key2));
	StringSetAdd(hss, key3, key3 + strlen(key3), key3, strlen(key3));

	ret = StringSetSearchMaxPre(hss, str3, str3 + strlen(str3), &data, &data_sz);
	printf("ret:%d %s\r\n", ret, (char *)data);

	ret = StringSetSearchMaxPre(hss, str4, str4 + strlen(str4), &data, &data_sz);
	printf("ret:%d %s\r\n", ret, (char *)data);

	ret = StringSetSearchMaxPre(hss, str5, str5 + strlen(str5), &data, &data_sz);
	printf("ret:%d %s\r\n", ret, (char *)data);

	ret = StringSetSearchMaxPre(hss, str6, str6 + strlen(str6), &data, &data_sz);
	printf("ret:%d %s\r\n", ret, (char *)data);
}
