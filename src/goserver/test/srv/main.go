...
func main() {
	...
	common.InitLog("./srv.log", "./srv_err.log", srvCfg.LogEnableConsolePrint, true, false)
	...
	if err != nil {
		common.LogErr("addr:", tcpAddr, " err:", err)
		return
	}
	common.LogDebug(tcpMgr)
