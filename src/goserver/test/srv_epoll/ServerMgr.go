...
const(
	EN_TCP_CLOSE_REASON_timeout  common.EN_TCP_CLOSE_REASON = common.EN_TCP_CLOSE_REASON_inter_max + 1
	EN_TCP_CLOSE_REASON_new_conn common.EN_TCP_CLOSE_REASON = common.EN_TCP_CLOSE_REASON_inter_max + 2
	EN_TCP_CLOSE_REASON_new_dial common.EN_TCP_CLOSE_REASON = common.EN_TCP_CLOSE_REASON_inter_max + 3
)
...
func (pthis*ServerMgr)TcpAcceptConnection(fd common.FD_DEF, addr net.Addr, inAttachData interface{}) (outAttachData interface{}){
	common.LogDebug(" accept connection fd:", fd.String(), " addr:", addr)
	return nil
}
func (pthis*ServerMgr)TcpDialConnection(fd common.FD_DEF, addr net.Addr, inAttachData interface{}) (outAttachData interface{}) {
	attachData, ok := inAttachData.(*TcpAttachData)
	if !ok || attachData == nil {
		common.LogErr(" dial connection no attach data, fd:", fd.String(), " addr:", addr, " inAttachData:", inAttachData)
		return
	}
...
func (pthis*ServerMgr)TcpData(fd common.FD_DEF, readBuf *bytes.Buffer, inAttachData interface{})(bytesProcess int, retAttachData interface{}) {
	...
	if inAttachData == nil {
		common.LogErr("fd:", fd.String(), " no attach data")
		return
	} else {
		tcpAttachData, ok := inAttachData.(*TcpAttachData)
		if !ok {
			common.LogErr("fd:", fd.String(), " unknown attach data", inAttachData)
			return
		}
		...
		if tcpAttachData.srvID != 0 {
			...
			if pu == nil {
				common.LogErr("fd:", fd.String(), " not process clientid:", tcpAttachData.cliID)
...
func (pthis*ServerMgr)TcpClose(fd common.FD_DEF, closeReason common.EN_TCP_CLOSE_REASON, inAttachData interface{}) {
	common.LogDebug("recv tcp close ", fd.String(), " attach data:", inAttachData, " closeReason:", closeReason)
	if inAttachData == nil{
		common.LogDebug("fd:", fd.String(), " not attach data")
...
func (pthis*ServerMgr)TcpOutBandData(fd common.FD_DEF, data interface{}, inAttachData interface{}) {

}
func (pthis*ServerMgr)TcpTick(fd common.FD_DEF, tNowMill int64, inAttachData interface{}){
...
func (pthis*ServerMgr)SendProtoMsg(fd common.FD_DEF, msgType msgpacket.MSG_TYPE, protoMsg proto.Message){
...
func (pthis*ServerMgr)Dump(bDetail bool)string{
	...
	var es common.EPollListenerStatic
...
func ConstructorServerMgr(addr string,
	...
	common.LogDebug("processUnitCount:", processUnitCount, "epollCoroutineCount:", epollCoroutineCount, "clientCloseTimeoutSec:", clientCloseTimeoutSec,
		"bET:", bET)
	...
	lsn, err := common.ConstructorEPollListener(eSrvMgr, addr, epollCoroutineCount, common.ParamEPollListener{ParamET: bET})
	if err != nil {
