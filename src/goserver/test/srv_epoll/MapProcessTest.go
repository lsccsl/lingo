...
func (pthis*MapAoiTestView)Ntf_in_view(objID int) {
	common.LogDebug(pthis.objID, " aoiID:", objID)
...
func (pthis*MapProcess)initTestViewNode() {
	...
	common.LogDebug("xRange:", xRange, " zRange:", zRange)
	...
	for i := 0; i < 100; i ++ {
		...
		common.LogDebug("add node:", aoi.objID, "[", x, "-", z, "]")
	}

	{
		...
		common.LogDebug("add node:", objID)
