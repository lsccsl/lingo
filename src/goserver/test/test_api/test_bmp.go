...
ERROR 2022-08-02T14:46:02.465792417+08:00[MapJPS.go:102] route:106 goserver/lin_common.(*JSPMgr).addNode already in history
goroutine 106 [running]:
runtime/debug.Stack()
        /home/lsc/go/go/src/runtime/debug/stack.go:24 +0x65
goserver/lin_common.LogErr({0xc00014fb78, 0x1, 0x1})
        /home/lsc/go/goserver/lingo/src/goserver/lin_common/log.go:63 +0x159
goserver/lin_common.(*JSPMgr).addNode(0xc0002224b0, 0xc00048b7a0, 0xc00048b740)
        /home/lsc/go/goserver/lingo/src/goserver/lin_common/MapJPS.go:102 +0x29f
goserver/lin_common.(*MapData).searchHorVer(0xc00040def0, 0xc0002224b0, 0xc00048b6e0, {0xc000622270, 0xc00014fd68}, 0x0, 0x1)
        /home/lsc/go/goserver/lingo/src/goserver/lin_common/MapJPS.go:370 +0x405
goserver/lin_common.(*MapData).PathJPS(0xc00040def0, {0x2, 0x2}, {0x3f, 0x11})
        /home/lsc/go/goserver/lingo/src/goserver/lin_common/MapJPS.go:562 +0xad3
main.(*TcpClient).Process_MSG_PATH_SEARCH(0xc000222140, 0xc0006200c0)
        /home/lsc/go/goserver/lingo/src/goserver/srv_epoll/TcpClient.go:100 +0x118
main.(*TcpClient).Process_protoMsg(0xc000222140, 0xc000620100)
        /home/lsc/go/goserver/lingo/src/goserver/srv_epoll/TcpClient.go:160 +0x14a
main.(*TcpClientMgrUnit)._go_Process_unit(0xc00042c990)
        /home/lsc/go/goserver/lingo/src/goserver/srv_epoll/TcpClientMgrUnit.go:120 +0xe5
created by main.ConstructorEpollServerMgr
        /home/lsc/go/goserver/lingo/src/goserver/srv_epoll/ServerMgr.go:280 +0x47f
...
ERROR 2022-08-02T14:46:05.879353639+08:00[MapJPS.go:102] route:106 goserver/lin_common.(*JSPMgr).addNode already in history
goroutine 106 [running]:
runtime/debug.Stack()
        /home/lsc/go/go/src/runtime/debug/stack.go:24 +0x65
goserver/lin_common.LogErr({0xc00015bb78, 0x1, 0x1})
        /home/lsc/go/goserver/lingo/src/goserver/lin_common/log.go:63 +0x159
goserver/lin_common.(*JSPMgr).addNode(0xc000222410, 0xc00060f440, 0xc00060f3e0)
        /home/lsc/go/goserver/lingo/src/goserver/lin_common/MapJPS.go:102 +0x29f
goserver/lin_common.(*MapData).searchHorVer(0xc00040def0, 0xc000222410, 0xc00060e6c0, {0xc00041c1a0, 0xc00015bd68}, 0x2, 0x1)
        /home/lsc/go/goserver/lingo/src/goserver/lin_common/MapJPS.go:370 +0x405
goserver/lin_common.(*MapData).PathJPS(0xc00040def0, {0x2, 0x2}, {0x35, 0x12})
        /home/lsc/go/goserver/lingo/src/goserver/lin_common/MapJPS.go:562 +0xad3
